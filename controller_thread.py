...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def startUpdateThread2(self):
        self.t2 = threading.Thread(target=self.updateThreadData2)
        print("Thread2 created")
        self.t2.start()
    
    def updateThreadData2(self):
        global runable
